...
mealsRouter.get('/', tokenExtractor_1.default, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const meals = yield entrySchema_1.default.find({ user: userID })
        .sort({ date: -1 })
...
mealsRouter.post('/', tokenExtractor_1.default, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const meal = yield entrySchema_1.default.find({ date, user: userID });
    if (meal.length > 0) {
    ...
    const mealEntry = new entrySchema_1.default({
        date,
        data,
        user: userID
    });
